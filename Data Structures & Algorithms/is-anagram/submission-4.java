class Solution {
    ...
    public boolean isAnagram(String s, String t) {
        ...
        // better way to compare both maps

        for (String sKey : sCounts.keySet()) {
            if (!sCounts.get(sKey).equals(tCounts.get(sKey))) {
                return false;
            }
        }

        for (String tKey : tCounts.keySet()) {
            if (!tCounts.get(tKey).equals(sCounts.get(tKey))) {
                return false;
            }
        }
        return true;
